...
var style_Population_Distribution_ColomboDistrict_Census2012_SL_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("TP");
    var labelText = "";
    size = 0;
    ...
    if (value >= 430.000000 && value <= 1450.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1450.000000 && value <= 2289.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2289.000000 && value <= 3401.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3401.000000 && value <= 5343.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5343.000000 && value <= 27309.000000) {
            style = [ new ol.style.Style({
